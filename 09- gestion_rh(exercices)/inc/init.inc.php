...
// définir le chemin absolu su site (comme dans wordpress)
define('RACINE_SITE', '/PHP/PHP_aout_wf3/09- gestion_rh(exercices)/');    // cette constante servira à créer les chemins absolus utilisés dans haut.inc.php car ce fichier sera inclus dans des scripts qui se situent dans des dossiers différents du site. On ne peut donc pas faire de chemin relatif dans ce fichier.
